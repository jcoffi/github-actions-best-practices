...
Use RedHat's YAML extension which utilizes [schemastore.org](https://www.schemastore.org/json/). This will provide tons of features such as syntax highlighting and formatting for YAML files, including GitHub Actions workflows.
